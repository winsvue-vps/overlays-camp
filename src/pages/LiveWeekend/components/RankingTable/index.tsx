...
export default function RankingTable() {
    ...
    const wrapperClass = `fixed top-[33rem] -translate-y-1/2 inset-0 flex flex-col items-center justify-center transition-all duration-700 ease-in-out ${isRankingCategory ? 'opacity-100 translate-x-0 pointer-events-auto' : 'opacity-0 -translate-x-[150%] pointer-events-none'}`;
