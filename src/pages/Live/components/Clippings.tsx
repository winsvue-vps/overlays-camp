...
export const Trapezoid = ({ fill = "#b99960", className }: { fill?: string; className?: string }) => {
  return (
...
export const ChamferedRect = ({ className }: { className?: string }) => {
  return (
    <svg width="56" height="64" viewBox="0 0 56 64" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M44.498 0.5L49.5293 7.14355H49.5303L55.5 15.7002V49.0029L49.126 56.168L49.1162 56.1797L42.9961 63.5H0.5V0.5H44.498Z" fill="#B99960" fill-opacity="0.8" stroke="url(#paint0_linear_2028_69)"/>
        <defs>
        <linearGradient id="paint0_linear_2028_69" x1="56.3143" y1="39.5582" x2="-25.2439" y2="43.8483" gradientUnits="userSpaceOnUse">
        <stop stop-color="#B99960"/>
        <stop offset="0.536251" stop-color="#B99960" stop-opacity="0"/>
        </linearGradient>
        </defs>
      </svg>
  )
