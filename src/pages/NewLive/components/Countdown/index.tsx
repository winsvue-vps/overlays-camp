...
function Counter(){
  ...
  const hasLiveRole = useUserStore((state) => state.hasLiveRole);
  ...
  const handleClickCountdown = async () => { 
    ...
    fivemRequest.post("/bot-api/tournament/countdown", { params: {
      ...
      <div className='flex items-center justify-center size-max group'>
        ...
        <div className='flex flex-col items-center justify-center italic font-extrabold w-[20rem] leading-none'>
          <motion.p
            ...
            className="text-[2rem] text-[#568EFF] group-hover:scale-110 transition-transform duration-300 h-[2.4rem]"
          >
            INICIANDO EM
          </motion.p>
